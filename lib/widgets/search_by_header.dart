...
import 'package:ecommmerce_app/screens/cart/cart_screen.dart';
import 'package:ecommmerce_app/screens/user_screen.dart';
              ...
              children: [
                Consumer<FavsProvider>(
                  builder: (_, favs, ch) => Badge(
                    ...
                    child: IconButton(
                      icon: Icon(Icons.favorite, color: ColorsConst.favColor),
                      onPressed: () {
